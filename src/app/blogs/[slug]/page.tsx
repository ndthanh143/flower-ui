...
import { ContentRendererClient } from '@/components';
...
export default async function BlogDetailPage({ params }: IBlogDetailPageProps) {
  ...
  return (
    <div className='container py-[20px]'>
      <h1 className='text-xl leading-[36px] md:text-2xl md:leading-[48px] lg:text-3xl lg:leading-[60px] text-[3xl] xl:text-4xl xl:leading-[80px]'>
        {data.title}
      </h1>
      <div className='flex my-8'>
        <div className='w-full h-full xl:h-[400px] xl:w-auto mx-auto rounded-lg overflow-hidden'>
          <Image
      ...
      <div className='text-base py-4 max-w-[1280px]'>
        <ContentRendererClient content={data.content} />
      </div>
    </div>
  );
}
